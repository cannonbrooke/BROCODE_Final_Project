...
subtitle: "BUS696 Final Project v22"
github: https://github.com/cannonbrooke/BROCODE_Final_Project
output:
  html_document:
    df_print: paged
...
spatial_data %>% 
  ...
  ggplot() +
    geom_sf(mapping = aes(fill = log(HH.Lifetime.Giving+1),na.rm=TRUE),
...
training <- subset(datavelvet, select= c(major_gifter,Age,sex_fct,Lifetime.Giving.Plus,jobtitle_simple

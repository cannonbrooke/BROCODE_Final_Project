...
subtitle: BUS696 Final Project v13
output:
  html_document:
    df_print: paged
...
library(glmnet)
library(glmnetUtils)
lasso_fit <- cv.glmnet(Lifetime.Giving ~ jobtitle_simple + deg1_simple + school1_simple + hhfirstgift_simple + maj1_simple + donorseg_simple,
                       data = data_train,
                       #Alpha 1 for lasso
                       alpha = 1)

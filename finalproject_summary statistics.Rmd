...
subtitle: "BUS696 Final Project v23"
...
ggplot(dataclean, aes(age_range,HH.Lifetime.Giving.Plus,fill = age_range)) + 
  geom_boxplot(
  outlier.colour = "red") + 
...
#cannot figure out how to exp the legend value after loggin HH.Lifetime.Giving 

...
1d Creating factor variable for donor segment 
...
#checking to see if its a factor
class(datacleaning$donorseg_fct)

#checking levels
levels(datacleaning$donorseg_simple)

#creating a table
table(datacleaning$donorseg_fct, datacleaning$donorseg_simple)


```

1e Creating factor variable for call preferences 
...
#checking to see if its a factor
class(datacleaning$contact_fct)

#checking levels
levels(datacleaning$contact_simple)

#creating a table
#table(datacleaning$contact_fct, datacleaning$contact_simple)
...
#checking to see if its a factor
class(datacleaning$spomail_fct)

#checking levels
levels(datacleaning$spomail_simple)

#creating a table 
#table(datacleaning$spomail_fct, datacleaning$spomail_simple)
...
Cleaning conferral dates, Last Contact By Anyone, Household First Gift Date
